...
public class GoodsApiUrl {
    ...
    // 获取产品列表
    public static final String PRODUCT_FIND_CURSOR = "/product/findCursor";
    //获取sku列表
    public static final String SKU_FIND_PAGE = "/sku/findPage";
    //获取属性列表
    public static final String SKU_FIND_PRODUCT = "/findByProductId";
    //获取标签列表
    ...
    //根据商品id获取标签
    public static final String TAG_FIND_BY_PRODUCT_ID = "/tag/findByProductId";
    //根据id获取仓库
    ...
    //商品id获取分类
    public static final String CATEGORY_FIND_BY_PRODUCT_ID = "/category/findByProductId";
}
