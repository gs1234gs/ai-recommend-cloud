...
public class SpeechRecognitionTest {
    ...
    static {
        ...
        DefaultProfile profile = DefaultProfile.getProfile(
                ...
                "LTAI5tNC3nPEEfGJ2P56wTvG",
                // 通过环境变量获取阿里云Ak Secret, 避免使用明文造成泄露风险
                // 如您未配置环境变量，请将下行代码中的System.getenv("AK_SECRET"))替换为AK Secret
               "5VeOsZIVmOSGPsBVWvIcyhE4y4MUbE");
        client = new DefaultAcsClient(profile);
    }
    public static void main(String[] args) {
        String voicePrefix = "cloneOk";
        String url = "https://web-eg-example01.oss-cn-beijing.aliyuncs.com/clone/download.WAV";
