...
public class SqlConst {
    ...
    public static final String SQL_EXCEPT = " except ";
    public static final String SQL_MIN = " min ";
    public static final String SQL_MAX = " max ";
    public static final String SQL_AVG = " avg ";
    ...
    public static final String SQL_OUTER_JOIN = " outer join ";
    public static final String SQL_FULL_JOIN = " full join ";
